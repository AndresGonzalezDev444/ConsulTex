    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        if (accion.equals("GuardarConsulta")) {
            ...
            if (resultadoBD.equals("OK")) {
                out.println("<script>alert('¡Ficha Médica guardada con éxito!'); window.location.href='"
                        + request.getContextPath() + "/ControladorPaciente?accion=misPacientes';</script>");
            } else {
                out.println("<script>alert('SQL Error: " + resultadoBD.replace("'", "")
